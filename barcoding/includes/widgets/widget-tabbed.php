...
<div id="tabbed" class="sidebar-block clearfix">
	<ul id="tabbed-area" class="clearfix">
		<li class="first"><a href="#recent-tabbed"><span><?php _e('Recent','DelicateNews'); ?></span></a></li>
		<li class="second"><a href="#popular-tabbed"><span><?php _e('Popular','DelicateNews'); ?></span></a></li>
		<li class="last"><a href="#random-tabbed"><span><?php _e('Random','DelicateNews'); ?></span></a></li>
	</ul>
	...
	<div id="all_tabs">
		...
		<div id="random-tabbed" class="tab">
			<ul>
				<?php query_posts("showposts=$randomNumber&caller_get_posts=1&orderby=rand");
					if (have_posts()) : while (have_posts()) : the_post(); ?>
						<?php include(TEMPLATEPATH . '/includes/fromblog_post.php'); ?>
					<?php endwhile; endif; wp_reset_query(); ?>
			</ul>
